...
try {
  fs.unlinkSync('/opt/project/imageprocess/others/captura_pantalla.png')
} catch(err) {
}

const size = (await image.getBufferAsync("image/jpeg")).byteLength;
const result = await image.writeAsync('/opt/project/imageprocess/others/captura_pantalla.png')
