...
const find = async () => {
// Load images
const original = await cv.imreadAsync(`/opt/project/imageprocess/others/capture.png`);

console.log(original)

const busqueda = await cv.imreadAsync(`/opt/project/imageprocess/others/recorte.png`);
